...
def collaboration_header(invoked_tool: str) -> str:
    ...
    return "\n".join(
        [
            ...
            "Claude and Codex are peers in judgment. Mutation ownership only says who may change state; it never says whose opinion ranks higher.",
            "Use the collaboration to supervise each other's reasoning, evidence, assumptions, and discipline.",
            "Do not let Claude's framing pull you along uncritically. Verify important claims with read-only investigation when useful, and push back with evidence.",
            "Expect Claude to apply the same standard to your advice and work.",
